...
export function UpdateActions(self: ModuleInstance): void {
  self.setActionDefinitions({
    ...
    patch_replicant_path: {
      ...
      description: 'Set a nested path on a writable Replicant. Requires the NodeCG bridge to implement replicant:patch.',
      options: [
        ...replicantTargetOptions(self, true),
        {
          type: 'textinput',
...
function replicantTargetOptions(self: ModuleInstance, writableOnly: boolean): SomeCompanionActionInputField<'replicant'>[] {
